...
public class GalerieController {
    ...
    public String afficheLesGaleries(Model model) {
     ...
     */
    @GetMapping(path = "add")
    public String FormulaireAjout(@ModelAttribute("galerie") Galerie galerie) {
    ...
    public String ajouteGalerieMontreListe(Galerie galerie, RedirectAttributes redirectInfo) {
        String message;
        try {
    ...
    public String supprimeCategorieMontreListe(@RequestParam("id") Galerie galerie,
